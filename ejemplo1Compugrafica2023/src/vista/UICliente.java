...
public class UICliente extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       try {
        String rutaArchivo = "lista.txt";
        BufferedWriter writer = new BufferedWriter(new FileWriter(rutaArchivo));

        for (Cliente cliente : listaClientes) {
            writer.write(cliente.getCodigoCliente() + "," + cliente.getEdadCliente() + "," +
                    cliente.getNombreP() + "," + cliente.getTelefonoP() + "," +
                    cliente.getCorreoP());
            writer.newLine();
        }

        writer.close();
        jTextArea1.setText("Datos guardados en el archivo: " + rutaArchivo);
    } catch (IOException e) {
        e.printStackTrace();
        jTextArea1.setText("Error al guardar los datos.");
    } 
